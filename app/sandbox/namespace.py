...
# Runs as root inside the fresh mount namespace, then execs the real command. Kept in a
# file so a process listing shows a short command line instead of the whole script.
SETUP_SCRIPT = Path(__file__).with_name("setup.sh")
